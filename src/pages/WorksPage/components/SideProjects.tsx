...
import { Badge, Box, Button, Flex, Grid, GridItem, HStack, Stack } from '@chakra-ui/react'
...
export default function SideProjects({ projects }: ISideProjectsProps) {
  const {
    limitedImageUrls: limitedProjects,
    shouldShowButton,
    leftOverImages: leftOverProjects,
    handleIncreaseLimit,
  } = useViewMore({
    arr: projects,
  })
  ...
  return (
    <Box as="section">
      ...
      <Stack gap={6}>
        ...
        {shouldShowButton && (
          <Button onClick={handleIncreaseLimit} size="xs" alignSelf="center">
            <BsEye /> View more visuals ({leftOverProjects})
          </Button>
        )}
      </Stack>
    </Box>
